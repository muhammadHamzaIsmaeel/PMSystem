...
export function KanbanColumn({ status, title, tasks, taskSubtaskCounts }: KanbanColumnProps) {
  ...
  return (
    <div className="flex flex-col bg-secondary-50 rounded-lg p-4 min-w-[300px] md:min-w-[320px] h-full">
      {/* Column Header */}
      ...
      <div
        ...
        className={`
          ...
          ${isOver ? 'bg-primary-100 ring-2 ring-primary-500 ring-inset' : 'bg-transparent'}
        `}
      >
