  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      >
        ...
        {unreadCount > 0 && (
          <span className="absolute top-0 right-0 inline-flex items-center justify-center px-2 py-1 text-xs font-bold leading-none text-white bg-error-600 rounded-full">
            ...
            {notifications.length === 0 ? (
              ...
              notifications.map((notification) => (
                <button
                  ...
                  className={\`w-full text-left p-4 border-b border-secondary-200 hover:bg-secondary-50 transition-colors \${
                ...
                >
                  <div className="flex gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className={\`text-sm text-secondary-900 \${!notification.is_read ? 'font-semibold' : ''}\`}>
